...
def withdrawal_func():
    ...
    enter_btn = Button(bf, text='ENTER', font=cour15, fg='red', command=question_func)
    enter_btn.pack(side=LEFT, pady=10)

    clear_btn = Button(bf, text='CLEAR', font=cour15, fg='yellow', command=lambda: money_entry.delete(1))
...
def message_func():
    ...
    message.pack()
    text = Label(win2, text='ATM', font=tim40, fg='pink')
    text.pack()
